%%   %!Tex TS-program = xelatex       ********** % Remove if you don't want to use xelatex
%%   %!TEX encoding = UTF-8 Unicode   ********** % Remove if you don't want to use xelatex
...
% \RequireXeTeX %Force XeTeX check  ******** % Remove if you don't want to use xelatex
...
\usepackage{capt-of}
\usepackage{hyperref}
% \usepackage{fontspec} %Font package %% uncomment to use other fonts, but uses xetex
% \usepackage{xltxtra} %% uncomment to use other fonts, but uses xetex
\usepackage{xunicode}

%Select fonts
% \newfontfamily\uni[Mapping=tex-text]{Hack Nerd Font} % Uncomment if you have the font locally
% \DeclareTextFontCommand{\unifont}{\uni} % Uncomment if you have the font locally
%
% Some unicode characters
% 
%
% \newfontfamily\ch[Mapping=tex-text]{HAN NOM A} % Uncomment if you have the font locally
% \DeclareTextFontCommand{\unifont}{\ch} % Uncomment if you have the font locally
...
% \usepackage{fontawesome5} % renderização de unicode % Uncomment if you have the font locally **** %
% \usepackage{ucs} % Uncomment if you have the font locally
