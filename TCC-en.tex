...
% Bem como a ciência se beneficia com seus rápidos avanços, de uma
% comunidade global de participantes, com as mais distintas
% especializações profissionais. Também, beneficia-se a computação com
% a comunidade aberta, e especialização eclética, tanto de membros
% quanto de softwares.
...
Last, we conclude synthesizing what has been understood from the
current work.

% We will demonstrate the validity of the hypothesis that an engineer
...
% Moreover, we will make the case for the adoption of FOSS by showing,

% \begin{enumerate}
% \item An entirely FOSS-based system performance;
% \item Softwares entirely developed by the community driven by intrinsic purpose, will to master tools and common interest;
% \item Effectiveness and comparative performance on the state of the art software found on FOSS applications;
% \item Picking applications with hardly any parallel in closed development.
% \item Covering a wide range of applications with different languages backing them up, but showing virtually no difference among easiness of use. Thus proving existence of standard development.
% \item Making reference and straightly running applications by following and understanding their Documentation.
% \end{enumerate}

% At the end of the document, one should get a sense of how it feels to develop and extend open software. 
